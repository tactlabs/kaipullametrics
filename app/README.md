...
Firstly, we will create a conda environment called *prettymetrics*
```
conda create -n prettymetrics python=3.7.9
```
Secondly, we will login to the *prettymetrics* environement
```
conda activate prettymetrics
```
